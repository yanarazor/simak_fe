...
class Migration_Install_kategori_berita_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Kategori_Berita.Site.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kategori_Berita.Site.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kategori_Berita.Site.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kategori_Berita.Site.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
