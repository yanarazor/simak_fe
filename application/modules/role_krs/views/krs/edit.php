	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('role_krs_action_edit'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/krs/role_krs', lang('role_krs_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Role_KRS.Krs.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('role_krs_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('role_krs_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
