...
class Migration_Install_role_krs_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Role_KRS.Krs.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Role_KRS.Krs.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Role_KRS.Krs.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Role_KRS.Krs.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
