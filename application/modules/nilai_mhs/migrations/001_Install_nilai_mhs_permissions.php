...
class Migration_Install_nilai_mhs_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Nilai_Mhs.Nilai.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Nilai_Mhs.Nilai.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Nilai_Mhs.Nilai.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Nilai_Mhs.Nilai.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
