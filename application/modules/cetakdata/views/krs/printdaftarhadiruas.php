...
?>
 <div style="margin-left:11px;margin-top:30px;"> 
    <table border="0" style="font-size:11px;font-weight:bold;" width="100%">
        ...
        DAFTAR HADIR UJIAN AKHIR</td></tr>		
    </table>
    <br> 
	...
	<tr>
		 ...
		 <th style="padding:5px;"width="100px">Nomor Pokok</th>
		 <th style="padding:5px;"width="250px">Nama</th> 
		  <th style="padding:5px;"width="350px">Tanda Tangan</th>
	</tr>
			   ...
			   <table border="0" width="100%">
				...
				<table border="0" style="font-size:10px;" width="100%">
				 ...
				 $hal = 1;
				  ...
				  <tr>
					<td valign="middle" align="center" style="padding:5px;height:16px;"> <?php echo $no; ?>. </td>
	...
	<br><br><br>
	 <table border="0" width="100%">
	   ...
	   <br>
   <center>
	   <a class="btn btn-large btnprint" target="_blank" href="<?php echo base_url().'admin/krs/cetakdata/printdaftarhadiruas/print?tahun='.$tahun.'&filfakultas='.$fakultas.'&filljurusan='.$jurusan.'&kode_mk='.$kode_mk.'&kelas='.$kelas.'&jml='.$jml.'&Act=Cari+&mod=print'; ?>">
		Cetak Data
		</a>
	</center>
</div> 
