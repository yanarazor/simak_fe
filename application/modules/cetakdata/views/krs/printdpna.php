...
?>
 <div style="margin-left:11px;margin-top:30px;"> 
    <table border="0" style="font-size:11px;font-weight:bold;" width="100%">
        ...
        DAFTAR PESERTA DAN NILAI AKHIR MAHASISWA</td></tr>		
    </table>
    <br> 
	...
	<tr>
		 ...
		 <th style="padding:5px;" width="50px">Tugas I</th>
		 <th style="padding:5px;" width="50px">UTS</th>
		 <th style="padding:5px;" width="50px">Tugas II</th>
		 <th style="padding:5px;" width="50px">UAS</th>
		 <th style="padding:5px;" width="50px">Nilai Agka</th>
		 <th style="padding:5px;" width="200px">Nilai Akhir</th>
	 </tr>
    	 ...
    	 <?php 
			   ...
			   <table border="0" width="100%">
				 ...
				 <table border="0" style="font-size:11px;font-weight:bold;" width="100%"  class="break">
					...
					<tr><td align="center"> Jl. K. H. Ahmad Dahlan Cirendeu Ciputat Jakarta Selatan	 </td></tr>
					<tr><td align="center"> <br>
					DAFTAR PESERTA DAN NILAI AKHIR MAHASISWA
					</td></tr>		
				</table>
				<br> 
				<table border="0" style="font-size:10px;" width="100%">
	...
	<br><br><br>
	 <table border="0" width="100%">
	   ...
	   <br>
   <center>
	   <a class="btn btn-large btnprint" target="_blank" href="<?php echo base_url().'admin/krs/cetakdata/printdpna/print?tahun='.$tahun.'&filfakultas='.$fakultas.'&filljurusan='.$jurusan.'&kode_mk='.$kode_mk.'&kelas='.$kelas.'&jml='.$jml.'&Act=Cari+&mod=print'; ?>">
		Cetak Data
		</a>
	</center>
</div> 
