...
class Migration_Install_kuesioner_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Kuesioner.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kuesioner.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kuesioner.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Kuesioner.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
