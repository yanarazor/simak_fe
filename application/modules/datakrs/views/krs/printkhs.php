...
<table border="0" style="font-size:16px;font-weight:bold;" width="100%">
	 ...
	 <tr>
	 	...
	 	<td align="center"><h2> UNIVERSITAS MUHAMMADIYAH JAKARTA </h2></td></tr>
	 <tr><td align="center"> <?php echo isset($datamahasiswa[0]->nama_fakultas) ? $datamahasiswa[0]->nama_fakultas : ""; ?> </td></tr>
	 <tr><td align="center"> Jl. K. H. Ahmad Dahlan Cirendeu Ciputat Jakarta Selatan Telp. 7402623</td></tr>
...
<table border="0" class="tableborder" width="100%">
 ...
 <table border="0" width="100%">
 	<tr>
	   ...
	   <br>
   <center>
	   <a class="btn btn-large btnprint" target="_blank" href="<?php echo site_url(SITE_AREA .'/krs/datakrs/printkhs/'); echo isset($sms)? "/".$sms:""; echo isset($mhs)? "/".$mhs:""; ?>/print">
		Cetak Data
		</a>
	</center>
</div> 
