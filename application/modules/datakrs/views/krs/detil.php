...
<div class="box box-warning admin-box">
	...
	<form action="<?php $this->uri->uri_string() ?>" method="get" accept-charset="utf-8">
    	...
    	<table>
            ...
            <tr>
                <td>
                	<input id='sms' type='text' class="form-control" name='sms' value="<?php echo set_value('sms', isset($sms) ? $sms : ''); ?>" />
				</td> 
                <td>
                	<select name="kode_mk" id="kode_mk" class="chosen-select-deselect form-control">
						 <option value=""></option>
   ...
   <div class="alert alert-block alert-warning fade in ">
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<a href="<?php echo base_url().'admin/krs/datakrs/printkrs/'; ?>/<?php echo $sms; ?>/print" class='fancy pull-right' target="_blank">
		   <span class="label label-success"><i class="fa fa-print"></i> Print KRS</span>
		</a>
		<br><br>
