				    ...
				    <table border="0" width="100%">
					  	...
					  	<tr>
					  		<td align="center" colspan="2">
					  			<?php if (isset($recordkrss) && is_array($recordkrss) && count($recordkrss) and $bukakrs == "1") { ?>
					  				<div class="alert alert-block alert-error fade in ">
										<a class="close" data-dismiss="alert">&times;</a>
					  			...
					  			<?php }else{ ?>
					  				<input type="submit" name="ambil" id="ambil-me" class="btn-large btn-primary" value="Konfirmasi" onclick="return confirm('<?php e(js_escape("Ambil Matakuliah")); ?>')" /> 
					  			<?php } ?>
					  		</td>
					  	</tr>
					  </table>
