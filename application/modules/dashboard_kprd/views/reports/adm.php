          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Jml Dosen</span>
               <span class="info-box-number"><a href="<?php echo base_url(); ?>admin/reports/dashboard_kprd/dosen"><?php echo isset($jumlahdosen) ? $jumlahdosen : "0"; ?> 
               	<small> Orang	</small></a>
               </span>
            </div>
            <!-- /.info-box-content -->
...
<div class='box box-primary'>
	...
	<script src="<?php echo base_url(); ?>themes/admin/plugins/jQuery/jquery-2.2.3.min.js"></script>
								...
								foreach ($jadwalngajars as $recordjadwal) : ?>
									<tr>
										...
										<td>
										   ...
										   <?php if($this->auth->has_permission('Nilai_Mahasiswa.Nilai.Create')){ ?>
											<a href="<?php echo base_url() ?>admin/settings/jadwal/addmateri/simple/<?php echo $recordjadwal->id; ?>?kode_mk=<?php echo $recordjadwal->kode_mk; ?>&tahun=<?php echo $recordjadwal->tahun_akademik; ?>&kelas=<?php echo $recordjadwal->kelas; ?>&sms=<?php echo $recordjadwal->semester; ?>&filljurusan=<?php echo $kode_prodi; ?>" tooltip="Nilai" class='show-modal' target="_blank">
												<span class="label label-success pull-right">Input</span>
											</a>
											<?php } ?>
										</td>
										<td>
										...
										<td>
											...
											<?php if($this->auth->has_permission('Nilai_Mahasiswa.Nilai.Create')){ ?>
											<a href="<?php echo base_url() ?>admin/nilai/nilai_mahasiswa/viewmahasiswa/simple/<?php echo $recordjadwal->id; ?>?kode_mk=<?php echo $recordjadwal->kode_mk; ?>&tahun=<?php echo $recordjadwal->tahun_akademik; ?>&kelas=<?php echo $recordjadwal->kelas; ?>&sms=<?php echo $recordjadwal->semester; ?>&filljurusan=<?php echo $kode_prodi; ?>" tooltip="Nilai" class='show-modal' target="_blank">
												<span class="label label-success pull-right">Input</span>
											</a>
											<?php } ?>
										</td>
	  ...
	  <div class="row">
	  	<center><h3>Rata-rata evaluasi Dosen per prodi</h3></center>
	  	<table class="table table-bordered">
						<thead>
							<tr>
								<th width="10px">#</th>
								<th> Prodi</th>
								<th width="0%">Rata-rata</th>
						...
						<tbody class="valign-middle">
							...
							<?php 
								if(isset($recordavgprodi) && is_array($recordavgprodi) && count($recordavgprodi)):
								$i=1;
								foreach ($recordavgprodi as $record) : ?>
									<tr>
										<td>
											<?php echo $i; ?>.
										</td>
										 <td><?php echo $record->nama_prodi; ?>
										 <td><?php echo $record->ratarata; ?></td> 
