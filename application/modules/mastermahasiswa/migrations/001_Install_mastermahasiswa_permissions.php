...
class Migration_Install_mastermahasiswa_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'MasterMahasiswa.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterMahasiswa.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterMahasiswa.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterMahasiswa.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
