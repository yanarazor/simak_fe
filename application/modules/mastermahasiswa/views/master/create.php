...
<?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
 <table border="0">
		...
		<td width="60%">
				...
				<fieldset>
					...
					<div class="control-group <?php echo form_error('mastermahasiswa_nama_mahasiswa') ? 'error' : ''; ?>">
						...
						<div class='controls'>
							<input id='mastermahasiswa_nama_mahasiswa' type='text' name='mastermahasiswa_nama_mahasiswa' maxlength="50" style="width:350px" value="<?php echo set_value('mastermahasiswa_nama_mahasiswa', isset($mastermahasiswa['nama_mahasiswa']) ? $mastermahasiswa['nama_mahasiswa'] : ''); ?>" />
					...
					<div class="control-group <?php echo form_error('jenis_kelamin') ? 'error' : ''; ?>">
					 ...
					 <div class='controls' arial-labelled-by='mastermahasiswa_jenis_kelamin_label'>
						 <label class='radios' for='mastermahasiswa_jenis_kelamin_option1'>
							 <input id='mastermahasiswa_jenis_kelamin_option1' name='mastermahasiswa_jenis_kelamin' type='radio' class='' value='L' <?php echo set_radio('mastermahasiswa_jenis_kelamin', 'L', TRUE); ?> />
							 Laki-laki
						 </label>
						 <label class='radios' for='mastermahasiswa_jenis_kelamin_option2'>
							 <input id='mastermahasiswa_jenis_kelamin_option2' name='mastermahasiswa_jenis_kelamin' type='radio' class='' value='P' <?php echo set_radio('mastermahasiswa_jenis_kelamin', 'L'); ?> />
							 Perempuan
						 </label>
					...
					<div class="control-group <?php echo form_error('semester') ? 'error' : ''; ?>">
						<?php echo form_label('Semester', 'mastermahasiswa_semester', array('class' => 'control-label') ); ?>
						<div class='controls'>
						   ...
						   <div id="logo">
							   <div class="get-photo" style="z-index: 690;"> 
								   <a href="<?php echo $this->settings_lib->item('site.urlphotomahasiswa').$foto; ?>">
									   ...
									   <span class="help-block">Photo size: 160 x 160 pixels</span>
    ...
    <div class="form-actions">
						<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('mastermahasiswa_action_create'); ?>"  />
						<?php echo lang('bf_or'); ?>
