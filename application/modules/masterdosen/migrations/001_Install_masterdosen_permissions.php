...
class Migration_Install_masterdosen_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'MasterDosen.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterDosen.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterDosen.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterDosen.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
