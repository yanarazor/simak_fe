	...
	<fieldset>
		<div class="control-group <?php echo form_error('masterdosen_kode_fakultas') ? 'error' : ''; ?>">
			...
			<div class="control-group <?php echo form_error('jenis_kelamin') ? 'error' : ''; ?>">
				...
				<div class='controls' arial-labelled-by='masterdosen_jenis_kelamin_label'>
					<label class='radios' for='masterdosen_jenis_kelamin_option1'>
						<input id='masterdosen_jenis_kelamin_option1' name='masterdosen_jenis_kelamin' type='radio' class='' value='L' <?php echo set_radio('masterdosen_jenis_kelamin', 'L', TRUE); ?> />
						Laki-laki
					</label>
					<label class='radios' for='masterdosen_jenis_kelamin_option2'>
						<input id='masterdosen_jenis_kelamin_option2' name='masterdosen_jenis_kelamin' type='radio' class='' value='P' <?php echo set_radio('masterdosen_jenis_kelamin', 'L'); ?> />
						Perempuan
					</label>
			...
			<div class="control-group <?php echo form_error('masterdosen_kode_status_kerja_pts') ? 'error' : ''; ?>">
				...
				<select name="masterdosen_kode_status_kerja_pts" id="masterdosen_kode_status_kerja_pts" class="chosen-select-deselect">
					...
					<span class='help-inline'><?php echo form_error('masterdosen_kode_status_kerja_pts'); ?></span>
				</div>
			</div>  
				...
				<select name="masterdosen_kode_status_aktivitas_dosen" id="masterdosen_kode_status_aktivitas_dosen" class="chosen-select-deselect">
					...
					<?php foreach($pilihan15s as $record):?>
						<option value="<?php echo $record->value?>" <?php if(isset($masterdosen['masterdosen_kode_status_aktivitas_dosen']))  echo  ($record->value==$masterdosen['masterdosen_kode_status_aktivitas_dosen']) ? "selected" : ""; ?>><?php echo $record->label; ?></option>
						<?php endforeach;?>
					<?php endif;?>
				</select>
        ...
        <td valign="top" align="center"> 
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('masterdosen_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
