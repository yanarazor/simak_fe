...
class site extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Konversi.Site.View');
	...
	{
		$this->auth->restrict('Konversi.Site.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_konversi())
			{
				...
				redirect(SITE_AREA .'/site/konversi');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Konversi.Site.Edit');
		...
		{
			$this->auth->restrict('Konversi.Site.Delete');
