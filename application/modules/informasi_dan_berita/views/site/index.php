...
<form action="<?php $this->uri->uri_string() ?>" method="get" accept-charset="utf-8">
   ...
   <div class="alert alert-block alert-warning fade in ">
      <a class="close" data-dismiss="alert">&times;</a>
       Jumlah :  <?php echo isset($total) ? $total : ''; ?> &nbsp; Informasi dan Berita
    </div>
			...
			<tbody>
				...
				<?php endif; ?>
					...
					<?php if(isset($record) && isset($record->foto) && $record->foto!='no image' && !empty($record->foto)) :
							...
							echo "<img alt=".$attachmentfile." title=".$attachmentfile." src='".$this->settings_lib->item('site.urlphotoartikel').$attachmentfile."' width='50px'>";
