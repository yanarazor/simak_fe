	...
	<?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('headline') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input id='informasi_dan_berita_headline' type='text' name='informasi_dan_berita_headline' maxlength="255" style="width:550px" value="<?php echo set_value('informasi_dan_berita_judul', isset($informasi_dan_berita['headline']) ? $informasi_dan_berita['headline'] : ''); ?>" />
            ...
            <input type="file" class="span6" name="file_upload" id="file_upload" /> 
                  ...
                  <?php if(!empty($informasi_dan_berita['foto'])) :
							...
							echo "<a href='".base_url().$this->settings_lib->item('site.urlphotoartikel').$attachmentfile."' class='fancy'/>"; 
							switch ($filetype) {
								 default:
      								echo "<img alt=".$attachmentfile." title=".$attachmentfile." src='".base_url().$this->settings_lib->item('site.urlphotoartikel').$attachmentfile."' width='100px'>";
							}
                        endif;
						echo "</a>";
                    ?>
         <span class="help-inline"><?php echo form_error('informasi_dan_berita_image'); ?></span>
			...
			<div class="control-group <?php echo form_error('auth_komen') ? 'error' : ''; ?>">
				<?php echo form_label('Autorisasi Komentar', '', array('class' => 'control-label', 'id' => 'informasi_dan_berita_auth_komen_label') ); ?>
				<div class='controls' aria-labelled-by='informasi_dan_berita_auth_komen_label'>
					<label class='radios' for='informasi_dan_berita_auth_komen_option1'>
					...
					<label class='radios' for='informasi_dan_berita_auth_komen_option2'>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('informasi_dan_berita_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
