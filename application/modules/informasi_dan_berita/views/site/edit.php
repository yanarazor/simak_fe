...
<div class="admin-box">
	...
	<?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
            ...
            <div class='controls'>
            <input type="file" class="span8" name="file_upload" id="file_upload" />  *Untuk Kategori Headline ukuran Gambar 1140 x 350
                  ...
                  <?php if(!empty($informasi_dan_berita['foto'])) :
							...
							echo "<a href='".$this->settings_lib->item('site.urlphotoartikel').$attachmentfile."' class='fancy'/>"; 
							switch ($filetype) {
								 default:
      								echo "<img alt=".$attachmentfile." title=".$attachmentfile." src='".$this->settings_lib->item('site.urlphotoartikel').$attachmentfile."' width='100px'>";
							}
                        endif;
						echo "</a>";
                    ?>
