...
<br>
<div class="admin-box">
	<h3>Tambah Data Jadwal Kuliah</h3>
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			<div class="control-group <?php echo form_error('tahun_akademik') ? 'error' : ''; ?>">
				  ...
				  <div class='controls'>
				  	<input id='tahun_akademik' type='text' name='tahun_akademik' maxlength="10" value="<?php echo set_value('tahun_akademik', isset($jadwal['tahun_akademik']) ? $jadwal['tahun_akademik'] : ''); ?>" />
				   ex 20142, 20151<!--
...
<script type="text/javascript">	  
	$("#tahun_akademik1").change(function(){
			...
			var json_url = "<?php echo base_url(); ?>index.php/admin/master/mastermatakuliah/getbytahun?tahun_akademik=" + encodeURIComponent(tahun_akademik)+"&jadwal_prodi=" + encodeURIComponent(jadwal_prodi)+"&jadwal_semester=" + encodeURIComponent(jadwal_semester);
