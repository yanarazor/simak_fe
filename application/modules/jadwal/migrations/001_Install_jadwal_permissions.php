...
class Migration_Install_jadwal_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Jadwal.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jadwal.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jadwal.Settings.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Jadwal.Settings.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
