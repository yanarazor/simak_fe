...
class Migration_Install_pengumuman_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Pengumuman.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Pengumuman.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Pengumuman.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Pengumuman.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
