...
class Migration_Install_range_nilai_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Range_Nilai.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Range_Nilai.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Range_Nilai.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Range_Nilai.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
