				...
				<?php endif; ?>
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu">
							<!-- <li><a href="<?php echo base_url()."admin/krs/transkip/view/".$record->nim_mhs; ?>" class="pay" kode="<?php e($record->id); ?>">Lihat Transkip</a></li> -->
							<li><a href="<?php echo base_url()."admin/krs/transkip/cari/?nim=".$record->nim_mhs; ?>" class="pay" kode="<?php e($record->id); ?>">Lihat Transkip</a></li>
