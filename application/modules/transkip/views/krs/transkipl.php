...
<div style="margin-left:0px;"> 
    <table border="0" width="100%">
    	...
    	<tr>
           ...
           <td align="left">Konsentrasi</td>
            <td align="left">:</td>
            <td align="left"><?php echo isset($nama_konsentrasi)?$nama_konsentrasi:"" ?> </td>
        </tr>
        <tr>
        	<td align="left"></td>
            <td></td>
	...
	<tr> 
		 ...
		 <th width="10px" rowspan="2" class="noborderbottom"></th>
		 <th style="padding:5px;" width="10px" rowspan="2">No</th>
		 <th style="padding:5px;" width="100px" rowspan="2">Kode MK</th>
		 <th style="padding:5px;" width="300px" rowspan="2">MATA KULIAH</th>
		 <th style="padding:5px;" width="50px" rowspan="2">SKS</th>
    ...
    <tr>
    	...
    	<td class="noborderbottom nobordertop">
    	</td>
    	<td class="noborderbottom">
    ...
    <?php 
    	...
    	?>
    		<tr>
			   ...
			   <td width="100px" class="noborderbottom">
					 <?php echo $kodemk1; ?>
				</td>
				<td width="245px" class="noborderbottom">
					 <?php 
					 echo isset($jsonkrs[$kodemk1][$sms]['namamtk']) ? $jsonkrs[$kodemk1][$sms]['namamtk'] : ""; ?>
				</td>
				<td width="52px" align="center" class="noborderbottom">
					 <?php 
					 //echo $rec." - ".$semester;
					 echo isset($jsonkrs[$kodemk1][$sms]['sks']) ? (int)$jsonkrs[$kodemk1][$sms]['sks'] : ""; ?>
				</td>
				<td width="50px" align="center" class="noborderbottom">
					 <?php 
					 echo $nilaiangka1;
    	...
    	?>
    		<tr>
			   ...
			   <td width="100px" class="noborderbottom">
				...
				<td class="noborderbottom" class="noborderbottom">
					<!-- semester 2 -->
				</td>
				<td width="22px" align="center" style="padding:5px;" class="noborderbottom">
					 <?php echo isset($jsonkrs[$kodemk2][$sms2]['namamtk']) ? $no2 : ""; ?>
    	...
    	?>
    		<tr>
			   ...
			   <td width="100px" class="noborderbottom">
				...
				<td class="nobordertop" class="noborderbottom">
					<!-- semester 2 -->
				</td>
				<td width="22px" align="center" style="padding:5px;" class="nobordertop">
					 <?php echo isset($jsonkrs[$kodemk2][$sms2]['namamtk']) ? $no2 : ""; ?>
	...
	<table border="0" width="100%">
    	...
    	<tr>
    		<td align="center" width="200px"> 
    			...
    			<br>
    			<?php echo $this->settings_lib->item('jabatanrektor'); ?>,
    			<br>
    			<br>
    			<br>
    			<br>
    			<br>
    			<br>
    			<?php echo $this->settings_lib->item('rektor'); ?>
   ...
   <center>
	   <a class="btn btn-large btnprint" target="_blank" href="<?php echo site_url(SITE_AREA .'/nilai/transkip/printtranskipl/');echo isset($mhs)? "/".$mhs:""; ?>/print/<?php echo isset($nilai) ? $nilai: ""; ?>?tanggal=<?php echo $tanggal; ?>">
		Cetak Data
		</a>
	</center>
</div> 
