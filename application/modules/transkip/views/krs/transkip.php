...
<div style="margin-left:0px;"> 
   ...
   <center>
	   <a class="btn btn-large btnprint" target="_blank" href="<?php echo site_url(SITE_AREA .'/nilai/transkip/printtranskip/');echo isset($mhs)? "/".$mhs:""; ?>/print/<?php echo isset($nilai) ? $nilai: ""; ?>?tanggal=<?php echo $tanggal; ?>">
		Cetak Data
		</a>
	</center>
</div> 
