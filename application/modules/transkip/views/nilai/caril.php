	...
	<form action="<?php $this->uri->uri_string() ?>" method="get" accept-charset="utf-8" id="frmcari">
    	...
    	<table>
            ...
            <tr>
             ...
             <tr>
               	<td>
                	<input id='tangaltandatangan' type='text' style="width:300px" name='tangaltandatangan' value="" placeholder="Tanggal Tandatangan" />
                </td> 
             ...
             <tr>
               	<td>
                	<input id='tanggallulus' type='text' style="width:300px" name='tanggallulus' value="" placeholder="Tanggal Kelulusan" />
                </td> 
...
function showdata(varnim,nilai){
		...
		var vartanggal 		= $("#tangaltandatangan").val();
		var vartanggallulus 		= $("#tanggallulus").val();
		
		var post_data = "valnim="+varnim+"&nilai="+nilai+"&tanggal="+vartanggal+"&tanggallulus="+vartanggallulus;
		//alert("<?php echo base_url() ?>index.php/admin/nilai/transkip/caritranskip?"+post_data);
	$.ajax({
			url: "<?php echo base_url() ?>index.php/admin/nilai/transkip/caritranskipl",
			type:"POST",
			data: post_data,
			dataType: "html",
			timeout:180000,
