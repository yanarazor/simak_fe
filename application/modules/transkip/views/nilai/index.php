				...
				<?php endif; ?>
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo base_url()."admin/nilai/transkip/cari/?nim=".$record->nim_mhs; ?>" class="pay" kode="<?php e($record->id); ?>">Transkip Sementara</a></li>
							<li><a href="<?php echo base_url()."admin/nilai/transkip/caril/?nim=".$record->nim_mhs; ?>" class="pay" kode="<?php e($record->id); ?>">Transkip Kelulusan</a></li>
							<li><a href="#>" class="pay" kode="<?php e($record->id); ?>">Lihat KHS</a></li> 
							<li><a href="<?php echo base_url()."admin/master/mastermahasiswa/edit/".$record->id; ?>" class="pay" kode="<?php e($record->id); ?>">Edit Data</a></li>
						</ul>
					</div>
