...
class Migration_Install_predikat_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Predikat.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Predikat.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Predikat.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Predikat.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
