	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset> 
			<div class="control-group <?php echo form_error('mastermatakuliah_kode_pt') ? 'error' : ''; ?>">
				...
				<div class='controls'>
			<input id='mastermatakuliah_kode_pt' readonly type='text' name='mastermatakuliah_kode_pt' maxlength="7" value="<?php echo $this->settings_lib->item('kode_pt');?>" />
			...
			<div class="control-group <?php echo form_error('mastermatakuliah_kode_prodi') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<select name="mastermatakuliah_kode_prodi" id="mastermatakuliah_kode_prodi" class="chosen-select-deselect">
						<option value=""></option>
			...
			<div class="control-group <?php echo form_error('mastermatakuliah_kode_jenjang_studi') ? 'error' : ''; ?>">
				<?php echo form_label('Jenjang Studi', 'mastermatakuliah_kode_jenjang_studi', array('class' => 'control-label') ); ?>
				<div class='controls'>
					<select name="mastermatakuliah_kode_jenjang_studi" id="mastermatakuliah_kode_jenjang_studi" class="chosen-select-deselect" style="width:300px;">
						<option value=""></option>
			...
			<div class="control-group <?php echo form_error('kode_kelompok') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<select name="mastermatakuliah_kode_kelompok" id="mastermatakuliah_kode_kelompok" class="chosen-select-deselect">
						<option value=""></option>
						<?php if (isset($pilihans10) && is_array($pilihans10) && count($pilihans10)):?>
						<?php foreach($pilihans10 as $record):?>
							<option value="<?php echo $record->value?>" <?php if(isset($mastermatakuliah['mastermatakuliah_kode_kelompok']))  echo  ($record->value==$mastermatakuliah['mastermatakuliah_kode_kelompok']) ? "selected" : ""; ?>><?php echo $record->label; ?></option>
							<?php endforeach;?>
						<?php endif;?>
					</select>
				...
				<div class='controls'>
					<select name="mastermatakuliah_kode_kurikulum" id="mastermatakuliah_kode_kurikulum" class="chosen-select-deselect">
						...
						<?php foreach($pilihans11 as $record):?>
							<option value="<?php echo $record->value?>" <?php if(isset($mastermatakuliah['mastermatakuliah_kode_kurikulum']))  echo  ($record->value==$mastermatakuliah['mastermatakuliah_kode_kelompok']) ? "selected" : ""; ?>><?php echo $record->label; ?></option>
							<?php endforeach;?>
						<?php endif;?>
					</select>
				...
				<div class='controls'>
					<select name="mastermatakuliah_kode_matkul" id="mastermatakuliah_kode_matkul" class="chosen-select-deselect">
						...
						<?php foreach($pilihans28 as $record):?>
							<option value="<?php echo $record->value?>" <?php if(isset($mastermatakuliah['mastermatakuliah_kode_matkul']))  echo  ($record->value==$mastermatakuliah['mastermatakuliah_kode_matkul']) ? "selected" : ""; ?>><?php echo $record->label; ?></option>
							<?php endforeach;?>
						<?php endif;?>
					</select>
				...
				<div class='controls'>
					<select name="mastermatakuliah_jenjang_prodi" id="mastermatakuliah_jenjang_prodi" class="chosen-select-deselect">
						...
						<?php foreach($pilihans04 as $record):?>
							<option value="<?php echo $record->value?>" <?php if(isset($mastermatakuliah['mastermatakuliah_jenjang_prodi']))  echo  ($record->value==$mastermatakuliah['mastermatakuliah_jenjang_prodi']) ? "selected" : ""; ?>><?php echo $record->label; ?></option>
							<?php endforeach;?>
						<?php endif;?>
					</select>
				...
				<div class='controls'>
					<select name="mastermatakuliah_status_mata_kuliah" id="mastermatakuliah_status_mata_kuliah" class="chosen-select-deselect">
						...
						<?php foreach($pilihans14 as $record):?>
							<option value="<?php echo $record->value?>" <?php if(isset($mastermatakuliah['mastermatakuliah_status_mata_kuliah']))  echo  ($record->value==$mastermatakuliah['mastermatakuliah_status_mata_kuliah']) ? "selected" : ""; ?>><?php echo $record->label; ?></option>
							<?php endforeach;?>
						<?php endif;?>
					</select>
			...
			<div class="control-group <?php echo form_error('silabus') ? 'error' : ''; ?>">
				...
				<div class='controls' aria-labelled-by='permasalahan_tingkat_masalah_label'>
					 
						<input id='status_display1' name='mastermatakuliah_silabus' type='radio' class='' value='Y' />
						Ya
					 
						<input id='status_display2' name='mastermatakuliah_silabus' type='radio' class='' value='T'  />
						Tidak
			...
			<div class="control-group <?php echo form_error('sap') ? 'error' : ''; ?>">
				...
				<div class='controls' aria-labelled-by='permasalahan_tingkat_masalah_label'>
						...
						<input id='status_display1' name='mastermatakuliah_sap' type='radio' class='' value='Y' />
						Ya
					 
						<input id='status_display2' name='mastermatakuliah_sap' type='radio' class='' value='T'  />
						Tidak
			...
			<div class="control-group <?php echo form_error('bahan_ajar') ? 'error' : ''; ?>">
				...
				<div class='controls' aria-labelled-by='permasalahan_tingkat_masalah_label'>
						...
						<input id='status_display1' name='mastermatakuliah_bahan_ajar' type='radio' class='' value='Y' />
						Ya
					 
						<input id='status_display2' name='mastermatakuliah_bahan_ajar' type='radio' class='' value='T'  />
						Tidak
			...
			<div class="control-group <?php echo form_error('diktat') ? 'error' : ''; ?>">
				...
				<div class='controls' aria-labelled-by='permasalahan_tingkat_masalah_label'>
						...
						<input id='status_display1' name='mastermatakuliah_diktat' type='radio' class='' value='Y' />
						Ya
					 
						<input id='status_display2' name='mastermatakuliah_diktat' type='radio' class='' value='T'  />
						Tidak
			...
			<div class="control-group <?php echo form_error('status') ? 'error' : ''; ?>">
				<?php echo form_label('Status', 'status', array('class' => 'control-label') ); ?>
					<div class='controls'>
						...
						<input id='status_wajib1' name='status_wajib' type='radio' class='' <?php if(isset($mastermatakuliah['status_wajib'])){ if($mastermatakuliah['status_wajib']=="w") echo  "checked"; } ?> value='w' />
						Wajib
					 
						<input id='status_wajib2' name='status_wajib' type='radio' class='' <?php if(isset($mastermatakuliah['status_wajib'])){ if($mastermatakuliah['status_wajib']=="p") echo  "checked"; }?> value='p'  />
						Pilihan
					<span class='help-inline'><?php echo form_error('status'); ?></span>
				</div>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('mastermatakuliah_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
