...
class Migration_Install_mastermatakuliah_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'MasterMataKuliah.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterMataKuliah.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterMataKuliah.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterMataKuliah.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
