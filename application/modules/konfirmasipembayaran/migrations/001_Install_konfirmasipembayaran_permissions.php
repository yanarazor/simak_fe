...
class Migration_Install_konfirmasipembayaran_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'KonfirmasiPembayaran.Pembayaran.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'KonfirmasiPembayaran.Pembayaran.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'KonfirmasiPembayaran.Pembayaran.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'KonfirmasiPembayaran.Pembayaran.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
