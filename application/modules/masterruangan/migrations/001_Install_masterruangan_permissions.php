...
class Migration_Install_masterruangan_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'MasterRuangan.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterRuangan.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterRuangan.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterRuangan.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
