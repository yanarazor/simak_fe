...
class Migration_Install_dokumen_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Dokumen.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Dokumen.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Dokumen.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Dokumen.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
