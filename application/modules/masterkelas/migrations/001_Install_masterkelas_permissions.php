...
class Migration_Install_masterkelas_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'MasterKelas.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterKelas.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterKelas.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterKelas.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
