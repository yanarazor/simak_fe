...
class Migration_Install_konfirmasi_pembayaran_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Konfirmasi_Pembayaran.Pembayaran.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Konfirmasi_Pembayaran.Pembayaran.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Konfirmasi_Pembayaran.Pembayaran.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Konfirmasi_Pembayaran.Pembayaran.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
