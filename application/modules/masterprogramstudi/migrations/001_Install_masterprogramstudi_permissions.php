...
class Migration_Install_masterprogramstudi_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'MasterProgramStudi.Master.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterProgramStudi.Master.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterProgramStudi.Master.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'MasterProgramStudi.Master.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
