...
<div class="control-group <?php echo form_error('kode_status_akreditasi') ? 'error' : ''; ?>">
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('masterprogramstudi_action_edit'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/master/masterprogramstudi', lang('masterprogramstudi_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('MasterProgramStudi.Master.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('masterprogramstudi_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('masterprogramstudi_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
