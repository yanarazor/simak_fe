...
<div class="admin-box">
	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('event_judul') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					...
					<span class='help-inline'><?php echo form_error('event_judul'); ?></span>
				</div>
			</div>
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('event_action_edit'); ?>"  />
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/site/event', lang('event_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Event.Site.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('event_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('event_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
