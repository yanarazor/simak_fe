<?php
	$this->load->library('KrsDetil');
	$KrsDetil = new KrsDetil();
...
<br/>
<center>
	   <a class="btn btn-large btnprint" target="_blank" href="<?php echo site_url(SITE_AREA .'/krs/krs_mahasiswa/printkartuall/'); echo isset($status)? "/".$status:""; echo isset($tahun_masuk)? "/".$tahun_masuk:""; ?>/<?php echo $prodi; ?>?mode=print">
		Cetak Data
		</a>
	</center>
...
$nomahasiswa = 1;
if (isset($datamahasiswa) && is_array($datamahasiswa) && count($datamahasiswa)) : 
foreach ($datamahasiswa as $recordmahasiswa) :
 
?>

 <table <?php if($nomahasiswa > 1) echo "class='break'"; ?> >
 	<tr>
 		<td valign="top" width="20%">
 			<table border="0" style="font-size:11px;font-weight:bold;" width="100%">
				 ...
				 <tr><td align="center"> FAKULTAS <?php echo isset($recordmahasiswa->nama_fakultas) ? $recordmahasiswa->nama_fakultas : ""; ?> </td></tr>
			 ...
			 <table border="0" width="100%" style="font-size:12px;font-weight:bold;">
				 <tr>
					 ...
					 <td align="center">:</td>
					 <td align="left" width="600px" ><?php echo isset($recordmahasiswa->nama_mahasiswa)?$recordmahasiswa->nama_mahasiswa:"" ?> </td>
				 </tr>
				 <tr>
					  
					 <td align="left"> Nomor Pokok  </td>
					  <td align="center">:</td>
					  <td align="left"><?php echo isset($recordmahasiswa->nim_mhs)?$recordmahasiswa->nim_mhs:"" ?></td>
				 </tr>
				 <tr>
					  
					 <td align="left"> Program Studi </td>
					  <td align="center">:</td>
					  <td align="left"><?php echo isset($recordmahasiswa->nama_prodi)?$recordmahasiswa->nama_prodi:"" ?></td>
				 </tr>
				 <tr>
 		...
 		<td>
 			<table border="1" width="100%" style="font-size:9px;font-weight:bold;">
			   <tr>
					...
					<?php 
					$nim = $recordmahasiswa->nim_mhs;
					$sms = $this->convert->getsemester($recordmahasiswa->nim_mhs,$this->settings_lib->item('site.tahun'));
					$datakrs = $KrsDetil->getdetilkrs($sms,$nim);
    ...
    <br/>
	 ...
	 <table border="0" width="100%" style="font-size:9px;font-weight:bold;">
        ...
        <tr>
            <td align="center" colspan="2">&nbsp;</td>
            <td align="center" colspan="4"><br><br><br> 
            ( .................................................................................. )</td>
            <td align="center" colspan="2">&nbsp;</td>
            <td align="center" colspan="4"><br><br><br> 
            ( .................................................................................. )</td>
