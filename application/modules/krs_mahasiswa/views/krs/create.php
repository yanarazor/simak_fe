				...
				<?php endif; ?>
					...
					<div class="dropdown">
						...
						<ul class="dropdown-menu">
							<li><a href="<?php echo base_url()."admin/krs/krs_mahasiswa/input/".$record->nim_mhs; ?>" class="pay" kode="<?php e($record->id); ?>">Buat KRS</a></li>
							<li><a class='fancy' href="<?php echo base_url()."admin/krs/krs_mahasiswa/lihatmatakuliahyangdiambil/simple/".$record->nim_mhs; ?>" class="pay" kode="<?php e($record->id); ?>">Lihat KRS</a></li> 
