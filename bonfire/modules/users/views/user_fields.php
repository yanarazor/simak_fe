...
<input type="hidden" id="timezones" name="timezones" value="UTC" />
<input type="hidden" id="country" name="country" value="ID" />
<input type="hidden" id="type" name="type" value="med" />
