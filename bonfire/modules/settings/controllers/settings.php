...
class Settings extends Admin_Controller
{
	...
	private function save_settings($extended_settings=array())
	{
		...
		$data = array(
			...
			array('name' => 'site.tahun', 'value' => $this->input->post('tahun')),
			array('name' => 'site.tahunajaran', 'value' => $this->input->post('tahunajaran')),
			...
			array('name' => 'kode_pt', 'value' => $this->input->post('kode_pt')),
			array('name' => 'nama_pt', 'value' => $this->input->post('nama_pt')),
			array('name' => 'sk_dikti', 'value' => $this->input->post('sk_dikti')),
			array('name' => 'tgl_sk_dikti', 'value' => $this->input->post('tgl_sk_dikti')),
			array('name' => 'tgl_akhir_sk_dikti', 'value' => $this->input->post('tgl_akhir_sk_dikti')),
			array('name' => 'alamat_pt1', 'value' => $this->input->post('alamat_pt1')),
			array('name' => 'alamat_pt2', 'value' => $this->input->post('alamat_pt2')),
			array('name' => 'kota_pt', 'value' => $this->input->post('kota_pt')),
			array('name' => 'kode_pos_pt', 'value' => $this->input->post('kode_pos_pt')),
			array('name' => 'tlp_pt', 'value' => $this->input->post('tlp_pt')),
			array('name' => 'fax_pt', 'value' => $this->input->post('fax_pt')),
			array('name' => 'tgl_akta_pt', 'value' => $this->input->post('tgl_akta_pt')),
			array('name' => 'no_akta_pt', 'value' => $this->input->post('no_akta_pt')),
			array('name' => 'website_pt', 'value' => $this->input->post('website_pt')),
			array('name' => 'tanggal_pendirian_pt', 'value' => $this->input->post('tanggal_pendirian_pt')),
			
			array('name' => 'site.updatekrs', 'value' => $this->input->post('updatekrs')),
			array('name' => 'kuesioner', 'value' => $this->input->post('kuesioner')),
			array('name' => 'kode_bh', 'value' => $this->input->post('kode_bh')),
			array('name' => 'nama_bh', 'value' => $this->input->post('nama_bh')),

			// tambahan
			array('name' => 'jabatanrektor', 'value' => $this->input->post('jabatanrektor')),
			array('name' => 'rektor', 'value' => $this->input->post('rektor')),
			array('name' => 'dekanfeb', 'value' => $this->input->post('dekanfeb')),
			array('name' => 'jabatan.transkip.sementara', 'value' => $this->input->post('jabatansementara')),
